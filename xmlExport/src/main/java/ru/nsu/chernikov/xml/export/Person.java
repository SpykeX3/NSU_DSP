...
public class Person {
    ...
    private final List<String> sisters = new ArrayList<>();
    private final List<String> brothers = new ArrayList<>();

    private final List<String> sons = new ArrayList<>();
    private final List<String> daughters = new ArrayList<>();
